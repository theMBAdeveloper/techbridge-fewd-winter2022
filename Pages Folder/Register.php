...
<section class="cont">
  <div class="container " data-aos="fade-up">
    ...
    <div class="row">
      <div class="col-lg-6  offset-lg-3 form login-form text-light">
        <form method="POST">
 ...
 <div class="form-group p-2">
          ...
          ?></small> </div>
              ...
              <div class="form-group p-2 mx-5 ">
                <input class="form-control text-center bg-dark text-light mb-2" style="width:100%;" type="submit" name="Signup" value="Signup">
              </div>
              <div class="link login-link text-center ">Already have an account? <a href="index.php?PageName=EmployeeLogin" class="text-secondary">login now</a></div>
        </form>
      </div>
    </div>

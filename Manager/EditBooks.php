            ...
            <div class="row">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title h3 text-center">Edit Books Form</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post">
...
<?php
                  ...
                  <div class="card-footer">
                    <input type="submit" name="submitBookForm" value="Save Changes" class="btn btn-primary form-control"></input>
                  </div>
                </form>
              </div>
              <!-- /.card -->

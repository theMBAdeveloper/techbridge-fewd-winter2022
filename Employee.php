...
if ($email != false && $password != false && $user == "Employee") {
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo  $fetch_info['UserName']; ?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Employee.php?PageName=MakeSale" class="nav-link">
               
                  <p>Make New Sale</p>
                </a>
              </li>
              <li class="nav-item">
                <a  href="Employee.php?PageName=SalesHistory" class="nav-link">

                  <p>View Sale History</p>
                </a>
              </li>
...
if (!empty($_GET['PageName'])) {
    ...
    include($PagesDirectory . '/MakeSale.php');
}
?>
      </div>
    </div>
